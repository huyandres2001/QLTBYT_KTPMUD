            ...
            <li class="form-line fixed-width jf-required" data-type="control_textbox" id="id_42">
                ...
                <div id="cid_42" class="form-input-wide jf-required" data-layout="half">
                    <input type="text" id="input_42" name="TenVatTu" data-type="input-textbox"
                        ...
                        value="{{ old('TenVatTu') }}" placeholder="Tên vật tư..." data-component="textbox"
                    ...
                    <div data-wrapper-react="true">
                        ...
                        <span class="form-sub-label-container" style="vertical-align:top">
                            <input type="date" name="HanSuDung"
                                ...
                                data-maxlength="12" maxLength="12" data-age="" value="{{old('HanSuDung')}}"
                                data-format="mmddyyyy" data-seperator="/" placeholder="MM/DD/YYYY"
            ...
            <li class="form-line form-line-column form-col-2" data-type="control_textarea" id="id_70">
                ...
                <div id="cid_70" class="form-input-wide" data-layout="full">
                    <textarea id="input_70" class="form-textarea" name="QuyTrinhSuDung"
                        value="{{old('QuyTrinhSuDung')}}" style="width:648px;height:163px" data-component="textarea"
                        aria-labelledby="label_70"></textarea>
                </div>
            </li>
            ...
            <li class="form-line form-line-column form-col-2" data-type="control_textarea" id="id_70">
                ...
                <div id="cid_70" class="form-input-wide" data-layout="full">
                    <textarea id="input_70" class="form-textarea" name="GhiChu"
                        value="{{old('GhiChu')}}" style="width:648px;height:163px" data-component="textarea"
                        aria-labelledby="label_70"></textarea>
                </div>
            </li>
            <li class="form-line" data-type="control_button" id="id_36">
