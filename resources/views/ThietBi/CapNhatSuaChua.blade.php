...
<form class="jotform-form" action="/thietbi/postcapnhat" method="post" id="220092097471454"
    ...
    <div role="main" class="form-all">
        ...
        <ul class="form-section page-section">
            ...
            <li class="form-line" data-type="control_datetime" id="id_66">
                <label class="form-label form-label-top form-label-auto" id="label_66" for="lite_mode_66"> Ngày sửa
                    chữa
                </label>
                <div id="cid_66" class="form-input-wide" data-layout="half">
                    <div data-wrapper-react="true">
                        <!-- -->
                        <span class="form-sub-label-container" style="vertical-align:top">
                            <input type="date" disabled readonly name="NgaySuaChua"
                                class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_66" size="12"
                                data-maxlength="12" maxLength="12" data-age="" value="{{$SuaChua->NgaySuaChua}}"
                                data-format="mmddyyyy" data-seperator="/" autoComplete="section-input_66 off"
                                aria-labelledby="label_66" />
                            <label class="form-sub-label is-empty" for="lite_mode_66" id="sublabel_66_litemode"
                                style="min-height:13px" aria-hidden="false"> </label>
            ...
            <li class="form-line form-line-column form-col-11" data-type="control_datetime" id="id_66">
                <label class="form-label form-label-top form-label-auto" id="label_66" for="lite_mode_66"> Ngày sửa
                    xong<span class="form-required">
                        *
                    </span>
                </label>
                <div id="cid_66" class="form-input-wide" data-layout="half">
                    <div data-wrapper-react="true">
                        <!-- -->
                        <span class="form-sub-label-container" style="vertical-align:top">
                            <input type="date" name="NgaySuaXong"
                                class="form-textbox validate[limitDate, validateLiteDate]" id="lite_mode_66" size="12"
            ...
            <li class="form-line form-line-column form-col-11" data-type="control_number" id="id_57">
                <label class="form-label form-label-top form-label-auto" id="label_57" for="input_57"> Chi phí<span class="form-required">
                    *
                </span>
                </label>
                <div id="cid_57" class="form-input-wide" data-layout="half">
                    <input type="number"  name="ChiPhi" id="input_57" data-type="input-number"
                        class=" form-number-input form-textbox" data-defaultvalue="" style="width:310px" size="310"
                         data-numbermin="1900" data-numbermax="2100"
                        data-component="number" aria-labelledby="label_57" step="any" />
                </div>
            </li>
            <li class="form-line form-line-column form-col-15" data-type="control_dropdown" id="id_82">
                <label class="form-label form-label-top form-label-auto" id="label_82" for="input_82"> Tình trạng sau khi sửa <span class="form-required">
                    *
                </span></label>
                <div id="cid_82" class="form-input-wide" data-layout="half">
                    <select name="TinhTrang" class="form-dropdown" style="width:310px;" id="input_82">
                        <option value=""> Chọn tình trạng </option>
                        <option value="Đang Sử Dụng"> Đã sửa xong, hoạt động tốt </option>
                        <option value="Ngừng Sử Dụng"> Không thể sửa, ngừng sử dụng </option>
                    </select>
                </div>
            </li>
